...
const PAGES = {
  ...
  orders: Orders,         grocery: Grocery,
  movies: Movies,         hotels: Hotels,
  rides: Rides,           bikes: Bikes,
  travel: Travel,         trains: Trains,
  medicine: Medicine,     leisure: Leisure,
  restaurants: Restaurants, users: Users,
  drivers: Drivers,       offers: Offers,
