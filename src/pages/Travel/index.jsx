...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Flight Bookings" sub="Real bookings from app"/>
      <div className="card">
        <div style={{textAlign:'center',padding:64,color:'var(--text-muted)'}}>
          <div style={{fontSize:48,marginBottom:16}}>✈️</div>
          <div style={{fontSize:16,fontWeight:600,color:'var(--text-secondary)',marginBottom:8}}>No Flight Bookings Yet</div>
